...
import main.java.files.zip.commons.FileUtils;
import main.java.files.zip.commons.FilenameUtils;
import main.java.files.zip.commons.IOUtils;
import main.java.files.zip.transform.ZipEntryTransformer;
import main.java.files.zip.transform.ZipEntryTransformerEntry;
...
public final class ZipUtil {
  ...
  private static final Logger log = LogManager.getLogger("org/zeroturnaround/zip/ZipUtil".replace('/', '.')); // NOSONAR
  ...
  public static boolean containsEntry(File zip, String name) {
    ...
    try {
      ...
      throw main.java.files.zip.ZipExceptionUtil.rethrow(e);
    }
    finally {
      closeQuietly(zf);
    }
   ...
   * @author Rein Raudjärv
   */
  private static class ByteArrayUnpacker implements main.java.files.zip.ZipEntryCallback {
   ...
   * @author Rein Raudjärv
   */
  private static class FileUnpacker implements main.java.files.zip.ZipEntryCallback {
   ...
   */
  public static void iterate(File zip, main.java.files.zip.ZipEntryCallback action) {
   ...
   * @see #iterate(File, ZipInfoCallback)
   */
  public static void iterate(File zip, main.java.files.zip.ZipEntryCallback action, Charset charset) {
    ZipFile zf = null;
    try {
      if (charset == null) {
        zf = new ZipFile(zip);
      ...
      while (en.hasMoreElements()) {
        ...
        catch (main.java.files.zip.ZipBreakException ex) {
          break;
        }
        finally {
          IOUtils.closeQuietly(is);
   ...
   */
  public static void iterate(File zip, String[] entryNames, main.java.files.zip.ZipEntryCallback action) {
   ...
   * @see #iterate(File, String[], ZipInfoCallback)
   */
  public static void iterate(File zip, String[] entryNames, main.java.files.zip.ZipEntryCallback action, Charset charset) {
    ZipFile zf = null;
    try {
      if (charset == null) {
        zf = new ZipFile(zip);
   ...
   */
  public static void iterate(File zip, main.java.files.zip.ZipInfoCallback action) {
    ZipFile zf = null;
    try {
      zf = new ZipFile(zip);
   ...
   */
  public static void iterate(File zip, String[] entryNames, main.java.files.zip.ZipInfoCallback action) {
    ZipFile zf = null;
    try {
      zf = new ZipFile(zip);
   ...
   * @see #iterate(File, ZipEntryCallback)
   */
  public static void iterate(InputStream is, main.java.files.zip.ZipEntryCallback action, Charset charset) {
    try {
   ...
   * @see #iterate(File, ZipEntryCallback)
   */
  public static void iterate(InputStream is, main.java.files.zip.ZipEntryCallback action) {
   ...
   * @see #iterate(File, String[], ZipEntryCallback)
   */
  public static void iterate(InputStream is, String[] entryNames, main.java.files.zip.ZipEntryCallback action, Charset charset) {
   ...
   * @see #iterate(File, String[], ZipEntryCallback)
   */
  public static void iterate(InputStream is, String[] entryNames, main.java.files.zip.ZipEntryCallback action) {
  ...
  private static ZipInputStream newCloseShieldZipInputStream(final InputStream is, Charset charset) {
    InputStream in = new BufferedInputStream(new main.java.files.zip.CloseShieldInputStream(is));
    if (charset == null) {
      return new ZipInputStream(in);
    }
    return main.java.files.zip.ZipFileUtil.createZipInputStream(in, charset);
  }
   ...
   * @see ZipEntryCallback
   */
  public static boolean handle(File zip, String name, main.java.files.zip.ZipEntryCallback action) {
    ZipFile zf = null;
    try {
      zf = new ZipFile(zip);
   ...
   * @see ZipEntryCallback
   */
  public static boolean handle(InputStream is, String name, main.java.files.zip.ZipEntryCallback action) {
   ...
   * @author Rein Raudjärv
   */
  private static class SingleZipEntryCallback implements main.java.files.zip.ZipEntryCallback {

    private final String name;

    private final main.java.files.zip.ZipEntryCallback action;

    private boolean found;

    public SingleZipEntryCallback(String name, main.java.files.zip.ZipEntryCallback action) {
      this.name = name;
      this.action = action;
    }
  ...
  public static void unpack(File zip, final File outputDir) {
    unpack(zip, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE);
  }
  ...
  public static void unpack(File zip, final File outputDir, Charset charset) {
    unpack(zip, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE, charset);
  }
   ...
   *          charset used to process the zip file
   */
  public static void unpack(File zip, File outputDir, main.java.files.zip.NameMapper mapper, Charset charset) {
   ...
   *          call-back for renaming the entries.
   */
  public static void unpack(File zip, File outputDir, main.java.files.zip.NameMapper mapper) {
    log.debug("Extracting '{}' into '{}'.", zip, outputDir);
  ...
  public static void unwrap(File zip, final File outputDir) {
    unwrap(zip, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE);
  }
   ...
   *          call-back for renaming the entries.
   */
  public static void unwrap(File zip, File outputDir, main.java.files.zip.NameMapper mapper) {
  ...
  public static void unpack(InputStream is, File outputDir) {
    unpack(is, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE, null);
  }
  ...
  public static void unpack(InputStream is, File outputDir, Charset charset) {
    unpack(is, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE, charset);
  }
   ...
   *          call-back for renaming the entries.
   */
  public static void unpack(InputStream is, File outputDir, main.java.files.zip.NameMapper mapper) {
   ...
   */
  public static void unpack(InputStream is, File outputDir, main.java.files.zip.NameMapper mapper, Charset charset) {
  ...
  public static void unwrap(InputStream is, File outputDir) {
    unwrap(is, outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE);
  }
   ...
   *          call-back for renaming the entries.
   */
  public static void unwrap(InputStream is, File outputDir, main.java.files.zip.NameMapper mapper) {
  ...
  private static File checkDestinationFileForTraversal(File outputDir, String name, File destFile) throws IOException {
    ...
    if (name.indexOf("..") != -1 && !destFile.getCanonicalPath().startsWith(outputDir.getCanonicalPath())) {
      throw new main.java.files.zip.MaliciousZipException(outputDir, name);
    }
    return destFile;
  }
   ...
   * @author Rein Raudjärv
   */
  private static class Unpacker implements main.java.files.zip.ZipEntryCallback {

    private final File outputDir;
    private final main.java.files.zip.NameMapper mapper;

    public Unpacker(File outputDir, main.java.files.zip.NameMapper mapper) {
    ...
    public void process(InputStream in, ZipEntry zipEntry) throws IOException {
      ...
      if (name != null) {
        ...
        main.java.files.zip.ZTFilePermissions permissions = main.java.files.zip.ZipEntryUtil.getZTFilePermissions(zipEntry);
        if (permissions != null) {
          main.java.files.zip.ZTFilePermissionsUtil.getDefaultStategy().setPermissions(file, permissions);
        }
      }
    }
  }
   ...
   * @since zt-zip 1.9
   */
  public static class BackslashUnpacker implements main.java.files.zip.ZipEntryCallback {

    private final File outputDir;
    private final main.java.files.zip.NameMapper mapper;

    public BackslashUnpacker(File outputDir, main.java.files.zip.NameMapper mapper) {
      this.outputDir = outputDir;
      this.mapper = mapper;
    }

    public BackslashUnpacker(File outputDir) {
      this(outputDir, main.java.files.zip.IdentityNameMapper.INSTANCE);
    }
   ...
   */
  private static class Unwrapper implements main.java.files.zip.ZipEntryCallback {

    private final File outputDir;
    private final main.java.files.zip.NameMapper mapper;
    private String rootDir;

    public Unwrapper(File outputDir, main.java.files.zip.NameMapper mapper) {
      this.outputDir = outputDir;
      this.mapper = mapper;
    }
  ...
  public static byte[] packEntry(File file) {
    ...
    try {
      ...
      ZipEntry entry = main.java.files.zip.ZipEntryUtil.fromFile(file.getName(), file);
      InputStream in = new BufferedInputStream(new FileInputStream(file));
      try {
        main.java.files.zip.ZipEntryUtil.addEntry(entry, in, out);
      }
      finally {
        IOUtils.closeQuietly(in);
      }
  ...
  public static void pack(File rootDir, File zip, int compressionLevel) {
    pack(rootDir, zip, main.java.files.zip.IdentityNameMapper.INSTANCE, compressionLevel);
  }
  ...
  public static void pack(final File sourceDir, final File targetZipFile, final boolean preserveRoot) {
    if (preserveRoot) {
      ...
      pack(sourceDir, targetZipFile, new main.java.files.zip.NameMapper() {
  ...
  public static void packEntry(File fileToPack, File destZipFile) {
    packEntry(fileToPack, destZipFile, main.java.files.zip.IdentityNameMapper.INSTANCE);
  }
  ...
  public static void packEntry(File fileToPack, File destZipFile, final String fileName) {
    packEntry(fileToPack, destZipFile, new main.java.files.zip.NameMapper() {
      public String map(String name) {
        return fileName;
      }
    });
   ...
   *          call-back for renaming the entries.
   */
  public static void packEntry(File fileToPack, File destZipFile, main.java.files.zip.NameMapper mapper) {
  ...
  public static void packEntries(File[] filesToPack, File destZipFile) {
    packEntries(filesToPack, destZipFile, main.java.files.zip.IdentityNameMapper.INSTANCE);
  }
   ...
   *          call-back for renaming the entries.
   */
  public static void packEntries(File[] filesToPack, File destZipFile, main.java.files.zip.NameMapper mapper) {
  ...
  public static void packEntries(File[] filesToPack, File destZipFile, int compressionLevel) {
    packEntries(filesToPack, destZipFile, main.java.files.zip.IdentityNameMapper.INSTANCE, compressionLevel);
  }
   ...
   *          <code>Deflater.BEST_COMPRESSION</code>
   */
  public static void packEntries(File[] filesToPack, File destZipFile, main.java.files.zip.NameMapper mapper, int compressionLevel) {
    ...
    try {
      ...
      for (int i = 0; i < filesToPack.length; i++) {
        ...
        ZipEntry zipEntry = main.java.files.zip.ZipEntryUtil.fromFile(mapper.map(fileToPack.getName()), fileToPack);
   ...
   *          call-back for renaming the entries.
   */
  public static void pack(File sourceDir, File targetZip, main.java.files.zip.NameMapper mapper) {
   ...
   *          compression level
   */
  public static void pack(File sourceDir, File targetZip, main.java.files.zip.NameMapper mapper, int compressionLevel) {
  ...
  public static void pack(File sourceDir, OutputStream os) {
    pack(sourceDir, os, main.java.files.zip.IdentityNameMapper.INSTANCE, DEFAULT_COMPRESSION_LEVEL);
  }
  ...
  public static void pack(File sourceDir, OutputStream os, int compressionLevel) {
    pack(sourceDir, os, main.java.files.zip.IdentityNameMapper.INSTANCE, compressionLevel);
  }
   ...
   * @since 1.10
   */
  public static void pack(File sourceDir, OutputStream os, main.java.files.zip.NameMapper mapper) {
   ...
   * @since 1.10
   */
  public static void pack(File sourceDir, OutputStream os, main.java.files.zip.NameMapper mapper, int compressionLevel) {
    ...
    if (error != null) {
      throw main.java.files.zip.ZipExceptionUtil.rethrow(error);
    }
  }
   ...
   */
  private static void pack(File dir, ZipOutputStream out, main.java.files.zip.NameMapper mapper, String pathPrefix, boolean mustHaveChildren) throws IOException {
    ...
    for (int i = 0; i < filenames.length; i++) {
      ...
      if (name != null) {
        ZipEntry zipEntry = main.java.files.zip.ZipEntryUtil.fromFile(name, file);
   ...
   */
  private static final class RepackZipEntryCallback implements main.java.files.zip.ZipEntryCallback {
    ...
    private RepackZipEntryCallback(File dstZip, int compressionLevel) {
      try {
        ...
        main.java.files.zip.ZipExceptionUtil.rethrow(e);
      }
    }

    public void process(InputStream in, ZipEntry zipEntry) throws IOException {
      main.java.files.zip.ZipEntryUtil.copyEntry(zipEntry, in, out);
    }
   ...
   * @since 1.9
   */
  public static void pack(main.java.files.zip.ZipEntrySource[] entries, OutputStream os) {
  ...
  private static void pack(main.java.files.zip.ZipEntrySource[] entries, OutputStream os, boolean closeStream) {
    try {
   ...
   */
  public static void pack(main.java.files.zip.ZipEntrySource[] entries, File zip) {
    if (log.isDebugEnabled()) {
  ...
  public static void addEntry(File zip, String path, File file, File destZip) {
    addEntry(zip, new main.java.files.zip.FileSource(path, file), destZip);
  }
  ...
  public static void addEntry(File zip, String path, byte[] bytes, File destZip) {
    addEntry(zip, new main.java.files.zip.ByteSource(path, bytes), destZip);
  }
  ...
  public static void addEntry(File zip, String path, byte[] bytes, File destZip, final int compressionMethod) {
    addEntry(zip, new main.java.files.zip.ByteSource(path, bytes, compressionMethod), destZip);
  }
   ...
   *          new ZIP file created.
   */
  public static void addEntry(File zip, main.java.files.zip.ZipEntrySource entry, File destZip) {
    addEntries(zip, new main.java.files.zip.ZipEntrySource[] { entry }, destZip);
  }
   ...
   *          new ZIP entry appended.
   */
  public static void addEntry(final File zip, final main.java.files.zip.ZipEntrySource entry) {
    operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
   ...
   *          new ZIP file created.
   */
  public static void addEntries(File zip, main.java.files.zip.ZipEntrySource[] entries, File destZip) {
    if (log.isDebugEnabled()) {
   ...
   */
  public static void addEntries(File zip, main.java.files.zip.ZipEntrySource[] entries, OutputStream destOut) {
    if (log.isDebugEnabled()) {
   ...
   * @since 1.9
   */
  public static void addEntries(InputStream is, main.java.files.zip.ZipEntrySource[] entries, OutputStream destOut) {
    if (log.isDebugEnabled()) {
   ...
   *          new ZIP entries appended.
   */
  public static void addEntries(final File zip, final main.java.files.zip.ZipEntrySource[] entries) {
    operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
  ...
  private static void copyEntries(File zip, final ZipOutputStream out) {
    ...
    iterate(zip, new main.java.files.zip.ZipEntryCallback() {
      public void process(InputStream in, ZipEntry zipEntry) throws IOException {
  ...
  private static void copyEntries(InputStream is, final ZipOutputStream out) {
    // this one doesn't call copyEntries with ignoredEntries, because that has poorer performance
    final Set<String> names = new HashSet<String>();
    iterate(is, new main.java.files.zip.ZipEntryCallback() {
      public void process(InputStream in, ZipEntry zipEntry) throws IOException {
        String entryName = zipEntry.getName();
        if (names.add(entryName)) {
          main.java.files.zip.ZipEntryUtil.copyEntry(zipEntry, in, out);
  ...
  public static boolean replaceEntry(File zip, String path, File file, File destZip) {
    return replaceEntry(zip, new main.java.files.zip.FileSource(path, file), destZip);
  }
  ...
  public static boolean replaceEntry(final File zip, final String path, final File file) {
    return operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
        return replaceEntry(zip, new main.java.files.zip.FileSource(path, file), tmpFile);
      }
    });
  }
  ...
  public static boolean replaceEntry(File zip, String path, byte[] bytes, File destZip) {
    return replaceEntry(zip, new main.java.files.zip.ByteSource(path, bytes), destZip);
  }
  ...
  public static boolean replaceEntry(final File zip, final String path, final byte[] bytes) {
    return operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
        return replaceEntry(zip, new main.java.files.zip.ByteSource(path, bytes), tmpFile);
      }
    });
  }
  ...
  public static boolean replaceEntry(final File zip, final String path, final byte[] bytes,
    ...
    return operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
        return replaceEntry(zip, new main.java.files.zip.ByteSource(path, bytes, compressionMethod), tmpFile);
      }
    });
  }
   ...
   * @return <code>true</code> if the entry was replaced.
   */
  public static boolean replaceEntry(File zip, main.java.files.zip.ZipEntrySource entry, File destZip) {
    return replaceEntries(zip, new main.java.files.zip.ZipEntrySource[] { entry }, destZip);
  }
   ...
   * @return <code>true</code> if the entry was replaced.
   */
  public static boolean replaceEntry(final File zip, final main.java.files.zip.ZipEntrySource entry) {
    return operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
   ...
   */
  public static boolean replaceEntries(File zip, main.java.files.zip.ZipEntrySource[] entries, File destZip) {
    if (log.isDebugEnabled()) {
      log.debug("Copying '" + zip + "' to '" + destZip + "' and replacing entries " + Arrays.asList(entries) + ".");
    }

    final Map<String, main.java.files.zip.ZipEntrySource> entryByPath = entriesByPath(entries);
        ...
        iterate(zip, new main.java.files.zip.ZipEntryCallback() {
          public void process(InputStream in, ZipEntry zipEntry) throws IOException {
            if (names.add(zipEntry.getName())) {
              main.java.files.zip.ZipEntrySource entry = (main.java.files.zip.ZipEntrySource) entryByPath.remove(zipEntry.getName());
              if (entry != null) {
                addEntry(entry, out);
              }
              else {
   ...
   * @return <code>true</code> if at least one entry was replaced.
   */
  public static boolean replaceEntries(final File zip, final main.java.files.zip.ZipEntrySource[] entries) {
    return operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
   ...
   *          new ZIP file created.
   */
  public static void addOrReplaceEntries(File zip, main.java.files.zip.ZipEntrySource[] entries, File destZip) {
    if (log.isDebugEnabled()) {
    ...
    try {
      ...
      try {
        ...
        // Add new entries
        for (main.java.files.zip.ZipEntrySource zipEntrySource : entryByPath.values()) {
   ...
   *          ZIP entries to be replaced or added.
   */
  public static void addOrReplaceEntries(final File zip, final main.java.files.zip.ZipEntrySource[] entries) {
    operateInPlace(zip, new InPlaceAction() {
      public boolean act(File tmpFile) {
   ...
   */
  static Map<String, main.java.files.zip.ZipEntrySource> entriesByPath(main.java.files.zip.ZipEntrySource... entries) {
    Map<String, main.java.files.zip.ZipEntrySource> result = new HashMap<String, main.java.files.zip.ZipEntrySource>();
    for (int i = 0; i < entries.length; i++) {
      main.java.files.zip.ZipEntrySource source = entries[i];
  ...
  private static class TransformerZipEntryCallback implements main.java.files.zip.ZipEntryCallback {
   ...
   *          target ZIP stream.
   */
  private static void addEntry(main.java.files.zip.ZipEntrySource entry, ZipOutputStream out) throws IOException {
