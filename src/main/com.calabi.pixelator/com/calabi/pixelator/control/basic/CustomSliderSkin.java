...
//    private boolean horizontal;
    ...
    private double thumbAuraWidth;
    private double thumbAuraHeight;
...
//    private double visibleAmount = 16;
     ...
     */
    public CustomSliderSkin(Slider control) {
        super(control);
...
//        control.setInputMap(behavior.getInputMap());
    ...
    @Override protected void layoutChildren(final double x, final double y,
        ...
        thumbAuraWidth = snapSizeX(thumbAura.prefWidth(-1));
        thumbAuraHeight = snapSizeY(thumbAura.prefHeight(-1));
        thumbAura.resize(thumbAuraWidth, thumbAuraHeight);
        ...
        if (getSkinnable().getOrientation() == Orientation.HORIZONTAL) {
            ...
            track.resizeRelocate((int)(trackStart - trackRadius),
                    ...
                    trackHeight);
            progress.resizeRelocate((int)(trackStart - trackRadius),
                    trackTop ,
                    (int)(thumb.getLayoutX() + trackRadius + trackRadius),
                    trackHeight);
            // layout tick line
            if (showTickMarks) {
            ...
            track.resizeRelocate(trackLeft,
                    ...
                    trackWidth,
                    (int)(trackLength + trackRadius + trackRadius));
            progress.resizeRelocate(trackLeft,
                    (int)(trackStart - trackRadius),
                    trackWidth,
                    (int)(thumb.getLayoutY() + trackRadius + trackRadius));
            // layout tick line
            if (showTickMarks) {
    ...
    private void initialize() {
        ...
        thumbAura = new StackPane();
        thumbAura.getStyleClass().setAll("thumb-aura");
        thumbAura.setMouseTransparent(true);
        track = new StackPane();
        track.getStyleClass().setAll("track");
        progress = new StackPane();
        progress.getStyleClass().setAll("bar");
    ...
    private void setShowTickMarks(boolean ticksVisible, boolean labelsVisible) {
        ...
        if (showTickMarks) {
            if (tickLine == null) {
                ...
                getChildren().clear();
                getChildren().addAll(tickLine, track, progress, thumbAura, thumb);
            } else {
                tickLine.setTickLabelsVisible(labelsVisible);
                tickLine.setTickMarkVisible(ticksVisible);
                tickLine.setMinorTickVisible(ticksVisible);
            ...
            getChildren().clear();
            getChildren().addAll(track, progress, thumbAura, thumb);
//            tickLine = null;
        }
    ...
    void positionThumb(final boolean animate) {
        ...
        if (animate) {
            ...
            Transition transition = new Transition() {
                ...
                @Override protected void interpolate(double frac) {
                    ...
                    if (!Double.isNaN(startY)) {
                        ...
                        thumbAura.setLayoutY(startY + frac * (endY - startY));
                    }
                }
            };
            transition.play();
            ...
            thumbAura.setLayoutX(endX - (thumbAuraWidth - thumbWidth) * 0.5);
            thumbAura.setLayoutY(endY - (thumbAuraHeight - thumbHeight) * 0.5);
        }
    }
